...
struct Complejo multiplicar(struct Complejo c1, struct Complejo c2){
    struct Complejo multiplicado;
    multiplicado.real = (c1.real * c2.real) - (c1.imaginaria * c2.imaginaria);
    multiplicado.imaginaria = (c1.real * c2.imaginaria) + (c1.imaginaria * c2.real);
    return multiplicado;
}
